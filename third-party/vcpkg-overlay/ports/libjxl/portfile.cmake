...
# Remove shared MinGW C++ runtime flags from pkg-config
# to avoid DLL dependencies at link time
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libjxl.pc" " -lstdc++" "")
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libjxl_cms.pc" " -lstdc++" "")
if(EXISTS "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libjxl.pc")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libjxl.pc" " -lstdc++" "")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libjxl_cms.pc" " -lstdc++" "")
endif()
