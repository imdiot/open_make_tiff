...
if(NOT LibRaw_r_LIBRARIES STREQUAL "")
    ...
    if ("@VCPKG_LIBRARY_LINKAGE@" STREQUAL "static")
        ...
        if("@ENABLE_DNGSDK@")
            find_package(adobe-dng-sdk CONFIG REQUIRED)
            list(APPEND LibRaw_LIBRARIES adobe::dng)
            list(APPEND LibRaw_r_LIBRARIES adobe::dng)
        endif()
        if("@ENABLE_RAWSPEED3@")
            find_package(rawspeed3 CONFIG REQUIRED)
            list(APPEND LibRaw_LIBRARIES rawspeed3::rawspeed3)
            list(APPEND LibRaw_r_LIBRARIES rawspeed3::rawspeed3)
        endif()
        if("@MATH_LIBRARY@")
